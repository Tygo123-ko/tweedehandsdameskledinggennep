...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Vera's Boutique" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "ClothingStore",
          name: "Vera's Boutique",
          description: "Tweedehands dameskleding in Gennep",
          telephone: "+31614208799",
          address: { "@type": "PostalAddress", addressLocality: "Gennep", addressCountry: "NL" },
          openingHours: ["Th 10:00-17:00", "Fr 10:00-17:00", "Sa 10:00-17:00"],
        }),
      },
    ],
  }),
